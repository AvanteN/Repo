...
int main(void)
{
 ...
 pthread_t thread1;
 FdPort1 = OpenSerial("/dev/ttyS3");
 memset(DataBuf,0,50*sizeof(unsigned char));

 RunOtherSerial = pthread_create(&thread1,
# 27 "uart.c" 3 4
                                         ((void *)0)
# 27 "uart.c"
                                             ,AnotherPortReceive,(void *)FdPort1);
...
# 57 "uart.c"
 ...
 switch(115200)
 {
  case 115200: newtio.c_cflag|=
# 61 "uart.c" 3 4
                              0010002
# 61 "uart.c"
                                     ;
        break;
  case 57600 : newtio.c_cflag|=
# 63 "uart.c" 3 4
                              0010001
# 63 "uart.c"
                                    ;
        break;
  default : newtio.c_cflag |=
# 65 "uart.c" 3 4
                            0010002
# 65 "uart.c"
                                   ;
